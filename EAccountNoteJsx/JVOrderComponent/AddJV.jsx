var AddJV = React.createClass({
    ...
    render: function() {
        return (
            <div ref={function (node) { this.Component = node; }.bind(this)} className="panel panel-EAccNotePrim">
                <AddEditHeader ShowList={this.props.ShowList} Title="Add JV" />
                <div className="panel-body">
                    <div className="row">
                        <div className="col-xs-6">
                            <div className="form-group">
                                <label className="mandatory">JV No.</label>
                                <input ref={function (node) { this.JVOrderNo = node; }.bind(this)} readOnly={true}
                        ...
                        <div className="col-xs-6">
                            <div className="form-group">
                                ...
                                <input ref={function (node) { this.AddedDt = node; }.bind(this)} readOnly={true}
                    ...
                    <div className="form-group">
                        ...
                        <ItemSelect ItemText={this.state.CrAccount.AccountName} ItemChange={this.inputChange} GoForItemSelect={this.goForCrAccountSelect} />
                    </div>
                    <div className="form-group">
    ...
    inputChange: function(){
        this.setState({NotValidInput: (this.Amount.value == 0 || 
            this.state.DrAccount.AccountId == -1 || 
            this.state.CrAccount.AccountId == -1 ||
            this.Remark.value.trim().length == 0)});
    },

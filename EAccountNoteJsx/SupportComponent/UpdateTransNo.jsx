var UpdateTransNo = React.createClass({
    ...
    render: function () {
        return (
            <div ref={function (node) { this.UpdateTransNo = node; }.bind(this)}
                ...
                <div className="panel-body">
                    <div className="form-group">
                        <label className="mandatory">Existing Transaction ID</label>
                        <input type="text" className="form-control" readOnly={true} value={this.state.Entity.TransactionId} />
                    </div>
                    <div className="checkbox" style={{ marginBottom: 0, marginTop: 0 }}>
                        <label><input ref={function (node) { this.CashPayment = node; }.bind(this)}
                            type="checkbox" checked={this.state.CashPayment} onChange={this.cashPaymentChange} />Cash Payment</label>
                    </div>
                    {!this.state.CashPayment &&
                        <div className="form-group">
                            <label className="mandatory">New Transaction ID</label>
                ...
                <div className="panel-footer" style={{ textAlign: "right" }}>
                    ...
                    <button className="btn btn-primary" disabled={this.state.NotValidInput} onClick={this.save}>Save</button>
                </div>
            </div>
        );
    },

var RevertAdvChargeTransList = React.createClass({
    displayName: "RevertAdvChargeTransList",
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(ListHeader, { ShowNextComponent: this.props.ShowNextComponent, ItemSelMode: true, Title: "Revert Adv Trans" }),
            React.createElement(
                "div",
    ...
    loadList: function (filter) {
        ...
        _ProgressBar.IMBusy();
        ajaxGet('RevertTrans/listAdvCharge' + urlParams, function (data) {
            _ProgressBar.IMDone();
            this.setState({
                Items: data
            });
    ...
    getList: function () {
        return this.state.Items.map(function (item) {
            return React.createElement(RevertAdvChargeTransRow, {

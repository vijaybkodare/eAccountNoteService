var AddTransToken = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(AddEditHeader, { ShowList: this.props.ShowList, Title: "Account Trans Token: " + this.AccountName }),
            React.createElement(
                "div",
                ...
                React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "select",
                                    { ref: function (node) {
                                            this.TokenTypes = node;
                                        }.bind(this), className: "form-control", onChange: this.actionOnTokenTypeChange,
                                        style: { borderTopRightRadius: "0px", borderBottomRightRadius: "0px" } },
                                    this.state.TokenTypes.map((item, index) => React.createElement(
                                        "option",
                                        { key: index, value: item.TokenTypeId },
                                        item.TokenName
                                    ))
                                )
                            )
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-xs-6", style: { paddingRight: "0px" } },
                                React.createElement(
                                    "label",
                                    { className: "mandatory" },
                                    "Value"
                                ...
                                React.createElement("input", { ref: function (node) {
                                        this.TokenValue = node;
                                    }.bind(this), value: this.state.TokenValue,
                            ...
                            React.createElement(
                                ...
                                React.createElement("input", { ref: function (node) {
                                        this.TokenWeight = node;
                                    }.bind(this), value: this.state.TokenWeight,
            ...
            React.createElement(AddEditFooter, { AllowDelete: false, Clear: this.clear, Save: this.save, NotValidInput: this.state.NotValidInput })
        );
    },
    ...
    loadTokenTypes: function () {
        ...
        ajaxGet('api/AutoTransEntry/getTransTokenTypes' + urlParams, function (data) {
            ...
            setTimeout(function () {
                this.tokenTypeChange(data[0].TokenTypeId);
            }.bind(this), 100);
        }.bind(this));
    },
    loadTokens: function () {
    ...
    getListRow: function (item) {
        return React.createElement(TransTokenRow, { key: item.AccountId + item.TokenValue + item.TokenTypeId,
            Entity: item,

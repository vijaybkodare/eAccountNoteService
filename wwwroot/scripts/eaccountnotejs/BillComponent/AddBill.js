var AddBill = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(AddEditHeader, { ShowList: this.props.ShowList, Title: 'Add/Edit Bill' }),
            React.createElement(
                'div',
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(ItemSelect, { ItemText: this.state.BankAccount.AccountName, ItemChange: this.inputChange, GoForItemSelect: this.goForBankAccountSelect })
                    ),
                    React.createElement(
                        'div',
                        { className: 'form-group' },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement('input', { ref: function (node) {
                                ...
                                type: 'file', className: 'btn btn-primary form-control' }),
                            React.createElement(
                                'span',
                                { className: 'input-group-addon' },
                                this.state.Entity.BillOrderId > -1 && React.createElement('span', { className: 'glyphicon glyphicon-ok paddingR5', style: { color: "green" }, onClick: this.saveBillFile, 'aria-hidden': 'true' })
                            )
                        )
                    )
                )
    ...
    save: function () {
        ...
        _ProgressBar.IMBusy();
        ajaxPost('BillOrder/save', dataToPost, function (data) {
            _ProgressBar.IMDone();
            if (data.IsSuccess) {
                this.props.ShowList();
            } else {

var RevertBillTransList = React.createClass({
    displayName: "RevertBillTransList",
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(ListHeader, { ShowNextComponent: this.props.ShowNextComponent, ItemSelMode: true, Title: "Revert Bill Trans" }),
            React.createElement(
                "div",
    ...
    loadList: function (filter) {
        ...
        _ProgressBar.IMBusy();
        ajaxGet('RevertTrans/listBillTrans' + urlParams, function (data) {
            _ProgressBar.IMDone();
            this.setState({
                Items: data
            });
    ...
    getList: function () {
        return this.state.Items.map(function (item) {
            return React.createElement(RevertBillTransRow, {

var UserList = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(ListHeader, { ShowNextComponent: this.props.ShowNextComponent, ItemSelMode: false, Title: "Users" }),
            React.createElement(
                "div",
    ...
    getList: function () {
        return this.state.Items.map(function (item) {
            if (item.UserName.toLowerCase().indexOf(this.state.Filter.toLowerCase()) > -1 || this.state.Filter == "") {

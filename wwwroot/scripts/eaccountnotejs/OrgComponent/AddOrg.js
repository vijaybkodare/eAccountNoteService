var AddOrg = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(AddEditHeader, { ShowList: this.props.ShowList, Title: "Add Organization" }),
            React.createElement(
                "div",
    ...
    inputChange: function () {
        if (this.UserName.value.length == 0 || this.EmailId.value.length == 0 || this.Address.value.length == 0 || this.OrgName.value.length == 0) this.setState({ NotValidInput: true });else this.setState({ NotValidInput: false });
    },

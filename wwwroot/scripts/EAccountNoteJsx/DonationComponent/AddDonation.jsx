    ...
    render: function () {
        return (
            <div ref={function (node) { this.Component = node; }.bind(this)} className="panel panel-EAccNotePrim">
                <AddEditHeader ShowList={this.props.ShowList} Title="Add/Edit Donation" />
                <div className="panel-body">
                    {
                        this.state.Entity.DonationHeaderId == -1 ?
                            <DonationHeaderEntry ref={function (node) { this.DonationHeaderEntry = node; }.bind(this)}

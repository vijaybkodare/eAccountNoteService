var Login = React.createClass({
    ...
    render: function () {
        ...
        return (
            <div ref={function (node) { this.Component = node; }.bind(this)}>
                <div className="panel panel-EAccNotePrim login-at-centre" onKeyPress={this.keyPress}>
                        ...
                        <div className="row">
                            <div className="col col-sm-12 col-sm-offset-0 col-md-8 col-md-offset-2">
                                ...
                                <ul className="nav nav-tabs">
                                    ...
                                    <li className={this.ActiveTab == 1 ? "active" : "deactive"}>
                                        <a href="#" onClick={this.activateTab1}>With OTP on Mobile</a></li>
                                </ul>
                                <div ref={function (node) { this.Tab0 = node; }.bind(this)} >
                                    <div className="alert alert-info alert2 fontSizeSr text-center" style={{ marginTop: 5 }}>
                                        Login with Password will be removed soon. Please register your Mobile # after login, to use OTP method.
                                    </div>
                                    <div className="input-group" style={{ marginBottom: 17, marginTop: 5 }}>
                                    ...
                                    <div className="input-group" style={{ marginBottom: 25 }}>
                                        <span className="input-group-addon" style={{ color: "black" }}>
                                            <span className="glyphicon glyphicon-lock" style={{ marginRight: 7 }}></span>
                                        </span>
                                ...
                                <div ref={function (node) { this.Tab1 = node; }.bind(this)} >
                                    ...
                                    <div className="text-center">
                                        <button type="button" disabled={!this.state.ValidMobileNo || this.state.BlocSendOtp} className="btn btn-primary custBtn" onClick={this.sendOtp}>
    ...
    sendOtp: function () {
        ...
        setTimeout(function () { this.setState({ BlocSendOtp: false }) }.bind(this), 30000);
        this.Otp.value = ""
